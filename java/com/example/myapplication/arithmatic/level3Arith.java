...
public class level3Arith extends AppCompatActivity {
...
int counter = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(getApplicationContext(), id,
        ...
        setContentView(R.layout.activity_level3_arith);
        input = findViewById(R.id.editTextTextPersonName8);
        input1 = findViewById(R.id.imageView112);
        input2 = findViewById(R.id.imageView117);
        input3 = findViewById(R.id.imageView115);
        input4 = findViewById(R.id.imageView118);
        input5 = findViewById(R.id.imageView107);
        input6 = findViewById(R.id.imageView119);
        input7 = findViewById(R.id.imageView113);
        input8 = findViewById(R.id.imageView111);
        input9 = findViewById(R.id.imageView108);
        input10 = findViewById(R.id.imageView114);
        enter = findViewById(R.id.imageView110);
        delete = findViewById(R.id.imageView180);
...
//BUTTON
        View.OnClickListener l = new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(abc.equals("12")){
                   if(counter == 0){
                       Intent i = new Intent(getApplicationContext(), SuccessArithActivity3.class).putExtra("usr",id).putExtra("score",score+2);
                       startActivity(i);
                       Toast.makeText(getApplicationContext(), "+2",
                               Toast.LENGTH_LONG).show();

                   }else if(counter ==1){
                       Intent i = new Intent(getApplicationContext(), SuccessArithActivity3.class).putExtra("usr",id).putExtra("score",score+1);
                       startActivity(i);
