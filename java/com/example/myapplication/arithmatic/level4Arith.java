...
public class level4Arith extends AppCompatActivity {
...
int counter =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level4_arith);
        ...
        input = findViewById(R.id.editTextTextPersonName9);
        input1 = findViewById(R.id.imageView125);
        input2 = findViewById(R.id.imageView130);
        input3 = findViewById(R.id.imageView128);
        input4 = findViewById(R.id.imageView131);
        input5 = findViewById(R.id.imageView120);
        input6 = findViewById(R.id.imageView132);
        input7 = findViewById(R.id.imageView126);
        input8 = findViewById(R.id.imageView124);
        input9 = findViewById(R.id.imageView121);
        input10 = findViewById(R.id.imageView127);
        enter = findViewById(R.id.imageView123);
        delete = findViewById(R.id.imageView181);
...
//BUTTON
        View.OnClickListener l = new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(abc.equals("30")){
                    if(counter == 0){
                        Intent i = new Intent(getApplicationContext(), ScoreArithMainActivity.class).putExtra("usr",id).putExtra("score",score+2);
                        startActivity(i);
                        Toast.makeText(getApplicationContext(), "+2",
                                Toast.LENGTH_LONG).show();

                    }else if (counter ==1){
                        Intent i = new Intent(getApplicationContext(), ScoreArithMainActivity.class).putExtra("usr",id).putExtra("score",score+1);
                        startActivity(i);
