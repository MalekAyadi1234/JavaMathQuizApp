...
public class level2Arith extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level2_arith);
        ...
        input = findViewById(R.id.editTextTextPersonName7);
        input1 = findViewById(R.id.imageView99);
        input2 = findViewById(R.id.imageView104);
        input3 = findViewById(R.id.imageView102);
        input4 = findViewById(R.id.imageView105);
        input5 = findViewById(R.id.imageView94);
        input6 = findViewById(R.id.imageView106);
        input7 = findViewById(R.id.imageView100);
        input8 = findViewById(R.id.imageView98);
        input9 = findViewById(R.id.imageView95);
        input10 = findViewById(R.id.imageView101);
        enter = findViewById(R.id.imageView97);
        delete = findViewById(R.id.imageView179);
        ...
        View.OnClickListener l = new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(abc.equals("360")){
                    //newscore+=2;
                    if (counter == 0){
                        Intent i = new Intent(getApplicationContext(), SuccessArithActivity2.class).putExtra("usr",id).putExtra("score",score+2);
                        startActivity(i);
                        ...
                        Intent i = new Intent(getApplicationContext(), SuccessArithActivity2.class).putExtra("usr",id).putExtra("score",score+1);
                        startActivity(i);
