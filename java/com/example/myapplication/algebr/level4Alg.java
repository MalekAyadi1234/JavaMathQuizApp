...
import com.example.myapplication.arithmatic.ScoreArithMainActivity;

public class level4Alg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level4_alg);

        Intent intent = getIntent();
        String id = intent.getStringExtra("usr");
        int score = intent.getIntExtra("score",newscore);

        input = findViewById(R.id.editTextTextPersonName4);
        input1 = findViewById(R.id.imageView60);
        input2 = findViewById(R.id.imageView65);
        input3 = findViewById(R.id.imageView63);
        input4 = findViewById(R.id.imageView66);
        input5 = findViewById(R.id.imageView55);
        input6 = findViewById(R.id.imageView67);
        input7 = findViewById(R.id.imageView61);
        input8 = findViewById(R.id.imageView59);
        input9 = findViewById(R.id.imageView56);
        input10 = findViewById(R.id.imageView62);
        enter = findViewById(R.id.imageView58);
        delete = findViewById(R.id.imageView176);
...
//BUTTON
        View.OnClickListener l = new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(abc.equals("1234")){
                    if(counter == 0){
                        Intent i = new Intent(getApplicationContext(), ScoreAlgMainActivity.class).putExtra("usr",id).putExtra("score",score+2);
                        startActivity(i);
                        Toast.makeText(getApplicationContext(), "+2",
                                Toast.LENGTH_LONG).show();

                    }else if (counter ==1){
                        Intent i = new Intent(getApplicationContext(), ScoreAlgMainActivity.class).putExtra("usr",id).putExtra("score",score+1);
                        startActivity(i);
