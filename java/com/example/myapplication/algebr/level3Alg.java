...
import com.example.myapplication.arithmatic.SuccessArithActivity3;

public class level3Alg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level3_alg);
        ...
        input1 = findViewById(R.id.imageView47);
        input2 = findViewById(R.id.imageView52);
        input3 = findViewById(R.id.imageView50);
        input4 = findViewById(R.id.imageView53);
        input5 = findViewById(R.id.imageView42);
        input6 = findViewById(R.id.imageView54);
        input7 = findViewById(R.id.imageView48);
        input8 = findViewById(R.id.imageView46);
        input9 = findViewById(R.id.imageView43);
        input10 = findViewById(R.id.imageView49);
        enter = findViewById(R.id.imageView45);
        delete = findViewById(R.id.imageView175);
...
//BUTTON
        View.OnClickListener l = new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(abc.equals("123")){
                    if(counter == 0){
                        Intent i = new Intent(getApplicationContext(), SuccessActivity3.class).putExtra("usr",id).putExtra("score",score+2);
                        startActivity(i);
                        Toast.makeText(getApplicationContext(), "+2",
                                Toast.LENGTH_LONG).show();

                    }else if(counter ==1){
                        Intent i = new Intent(getApplicationContext(), SuccessActivity3.class).putExtra("usr",id).putExtra("score",score+1);
                        startActivity(i);
